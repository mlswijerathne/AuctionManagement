      ...
      <Container component="main" maxWidth="lg">
        <Box
          sx={{
            marginTop: 8,
            padding: 4,
            backgroundColor: '#f3f3f3', // Light background for a clean look
            borderRadius: 2,
          }}
        >
          <Box
          ...
          >
            <Typography 
              ...
              sx={{
                ...
                fontWeight: 'bold',
                '& span': {
                  color: 'orange', // Orange color for the word 'Auctions'
                }
              }}
            >
              Available <span>Auctions</span>
            </Typography>
            <Button
              variant="contained"
              sx={{ 
                  ...
                  <Card 
                    sx={{ 
                      ...
                      '&:hover': {
                        ...
                        boxShadow: '0 4px 8px rgba(0, 0, 0, 0.2)', // Enhance hover effect
                      }
                    }}
                  >
                    <CardMedia
